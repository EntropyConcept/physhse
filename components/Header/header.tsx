          ...
          <div className={style.container}>
              <div className={style.left}>
                  <div className={style.label}>
                      <Link passHref href="/"><img src="/hse3.svg" alt="hse-logo" className={style.logo}/></Link>
                  </div>
                  <div className={style.buttons}>
                    <Link passHref href="/"><button className={classNames({[style.selected]:props.tab == 0 || dir[1] == "main" || dir[1] == ""})}>Главная</button></Link>
