  ...
  return (
    <>
      ...
      <Table top static data={[{name: "Первый семестр"}]}/>
        ...
        <Table data ={half1.map(entry=>{return {name: entry.name, link: "/c2/" + entry.token}})} year={2} half={1}/>
        ...
        <Table bottom data ={half2.map(entry=>{return {name: entry.name, link: "/c2/" + entry.token}})} year={2} half={2}/>
